<?php get_header(); ?>
    ...
    <div class="content pull-left">
        ...
        <form role="search" method="get" id="searchform" class="form-search" action="http://wordpress/">
            <div class="input-append">
                <input type="text" value="" name="s" id="s" class="search-query" placeholder="Попробовать ещё раз?" />
