...
function art_add_admin() {
    ...
    add_theme_page("Medical Theme WP Options", "Medical Theme WP Options", 'edit_themes', basename(__FILE__), 'art_admin');
...
?>
<div class="wrap">
	<h2>Medical Theme WP Options</h2>
...
<div class="art-PostContent">
      ...
      <div class="comment-author vcard border-bottom-line">
